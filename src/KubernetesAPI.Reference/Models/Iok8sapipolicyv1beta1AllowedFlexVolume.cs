...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// used.
    /// </summary>
    public partial class Iok8sapipolicyv1beta1AllowedFlexVolume
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapipolicyv1beta1AllowedFlexVolume class.
        /// </summary>
        public Iok8sapipolicyv1beta1AllowedFlexVolume()
        {
            CustomInit();
        }
        ...
        /// driver.</param>
        public Iok8sapipolicyv1beta1AllowedFlexVolume(string driver)
        {
            Driver = driver;
            CustomInit();
        }
