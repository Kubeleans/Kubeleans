...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapicorev1CSIPersistentVolumeSource
    {
        ...
        /// publish.</param>
        public Iok8sapicorev1CSIPersistentVolumeSource(string driver, string volumeHandle, Iok8sapicorev1SecretReference controllerPublishSecretRef = default(Iok8sapicorev1SecretReference), string fsType = default(string), Iok8sapicorev1SecretReference nodePublishSecretRef = default(Iok8sapicorev1SecretReference), Iok8sapicorev1SecretReference nodeStageSecretRef = default(Iok8sapicorev1SecretReference), bool? readOnlyProperty = default(bool?), IDictionary<string, string> volumeAttributes = default(IDictionary<string, string>))
        {
        ...
        public Iok8sapicorev1SecretReference ControllerPublishSecretRef { get; set; }
        ...
        public Iok8sapicorev1SecretReference NodePublishSecretRef { get; set; }
        ...
        public Iok8sapicorev1SecretReference NodeStageSecretRef { get; set; }
