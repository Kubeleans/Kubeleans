...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionNames
    {
        ...
        /// &lt;kind&gt;</param>
        public Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceDefinitionNames(string kind, string plural, IList<string> categories = default(IList<string>), string listKind = default(string), IList<string> shortNames = default(IList<string>), string singular = default(string))
        {
