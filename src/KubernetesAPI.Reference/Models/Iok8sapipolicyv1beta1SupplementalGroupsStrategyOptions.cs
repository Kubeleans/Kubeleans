...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapipolicyv1beta1SupplementalGroupsStrategyOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapipolicyv1beta1SupplementalGroupsStrategyOptions class.
        /// </summary>
        public Iok8sapipolicyv1beta1SupplementalGroupsStrategyOptions()
        {
            CustomInit();
        }
        ...
        public Iok8sapipolicyv1beta1SupplementalGroupsStrategyOptions(IList<Iok8sapipolicyv1beta1IDRange> ranges = default(IList<Iok8sapipolicyv1beta1IDRange>), string rule = default(string))
        {
            Ranges = ranges;
            Rule = rule;
            CustomInit();
