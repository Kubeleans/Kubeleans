...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapicorev1SecurityContext
    {
        ...
        /// PodSecurityContext, the value specified in SecurityContext takes
        /// precedence.</param>
        public Iok8sapicorev1SecurityContext(bool? allowPrivilegeEscalation = default(bool?), Iok8sapicorev1Capabilities capabilities = default(Iok8sapicorev1Capabilities), bool? privileged = default(bool?), bool? readOnlyRootFilesystem = default(bool?), long? runAsGroup = default(long?), bool? runAsNonRoot = default(bool?), long? runAsUser = default(long?), Iok8sapicorev1SELinuxOptions seLinuxOptions = default(Iok8sapicorev1SELinuxOptions))
        {
