...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// the ClusterRole
    /// </summary>
    public partial class Iok8sapirbacv1alpha1AggregationRule
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapirbacv1alpha1AggregationRule class.
        /// </summary>
        public Iok8sapirbacv1alpha1AggregationRule()
        {
            CustomInit();
        }
        ...
        public Iok8sapirbacv1alpha1AggregationRule(IList<Iok8sapimachinerypkgapismetav1LabelSelector> clusterRoleSelectors = default(IList<Iok8sapimachinerypkgapismetav1LabelSelector>))
        {
