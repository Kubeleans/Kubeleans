...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapistoragev1beta1VolumeAttachment
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapistoragev1beta1VolumeAttachment class.
        /// </summary>
        public Iok8sapistoragev1beta1VolumeAttachment()
        {
            CustomInit();
        }
        ...
        public Iok8sapistoragev1beta1VolumeAttachment(Iok8sapistoragev1beta1VolumeAttachmentSpec spec, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta), Iok8sapistoragev1beta1VolumeAttachmentStatus status = default(Iok8sapistoragev1beta1VolumeAttachmentStatus))
        {
        ...
        public Iok8sapistoragev1beta1VolumeAttachmentSpec Spec { get; set; }
        ...
        public Iok8sapistoragev1beta1VolumeAttachmentStatus Status { get; set; }
