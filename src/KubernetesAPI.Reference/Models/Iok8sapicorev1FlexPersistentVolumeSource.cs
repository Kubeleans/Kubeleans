...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapicorev1FlexPersistentVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapicorev1FlexPersistentVolumeSource class.
        /// </summary>
        public Iok8sapicorev1FlexPersistentVolumeSource()
        {
            CustomInit();
        }
        ...
        public Iok8sapicorev1FlexPersistentVolumeSource(string driver, string fsType = default(string), IDictionary<string, string> options = default(IDictionary<string, string>), bool? readOnlyProperty = default(bool?), Iok8sapicorev1SecretReference secretRef = default(Iok8sapicorev1SecretReference))
        {
            Driver = driver;
            FsType = fsType;
            Options = options;
