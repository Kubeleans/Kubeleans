...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapipolicyv1beta1IDRange
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapipolicyv1beta1IDRange
        /// class.
        /// </summary>
        public Iok8sapipolicyv1beta1IDRange()
        {
            CustomInit();
        }
        ...
        public Iok8sapipolicyv1beta1IDRange(long max, long min)
        {
            Max = max;
            Min = min;
            CustomInit();
