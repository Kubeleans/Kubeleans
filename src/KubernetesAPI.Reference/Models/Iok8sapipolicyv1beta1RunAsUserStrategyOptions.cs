...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapipolicyv1beta1RunAsUserStrategyOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapipolicyv1beta1RunAsUserStrategyOptions class.
        /// </summary>
        public Iok8sapipolicyv1beta1RunAsUserStrategyOptions()
        {
            CustomInit();
        }
        ...
        /// be used.</param>
        public Iok8sapipolicyv1beta1RunAsUserStrategyOptions(string rule, IList<Iok8sapipolicyv1beta1IDRange> ranges = default(IList<Iok8sapipolicyv1beta1IDRange>))
        {
            Ranges = ranges;
            Rule = rule;
            CustomInit();
