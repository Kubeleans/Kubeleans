...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// can be set.
    /// </summary>
    public partial class Iok8sapistoragev1beta1VolumeAttachmentSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapistoragev1beta1VolumeAttachmentSource class.
        /// </summary>
        public Iok8sapistoragev1beta1VolumeAttachmentSource()
        {
            CustomInit();
        }
        ...
        /// attach.</param>
        public Iok8sapistoragev1beta1VolumeAttachmentSource(string persistentVolumeName = default(string))
        {
