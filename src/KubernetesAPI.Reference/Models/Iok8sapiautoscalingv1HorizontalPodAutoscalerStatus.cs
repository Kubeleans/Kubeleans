...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapiautoscalingv1HorizontalPodAutoscalerStatus
    {
        ...
        public Iok8sapiautoscalingv1HorizontalPodAutoscalerStatus(int currentReplicas, int desiredReplicas, int? currentCPUUtilizationPercentage = default(int?), System.DateTimeOffset? lastScaleTime = default(System.DateTimeOffset?), long? observedGeneration = default(long?))
        {
