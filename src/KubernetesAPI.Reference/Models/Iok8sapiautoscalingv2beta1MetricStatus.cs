...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapiautoscalingv2beta1MetricStatus
    {
        ...
        public Iok8sapiautoscalingv2beta1MetricStatus(string type, Iok8sapiautoscalingv2beta1ExternalMetricStatus external = default(Iok8sapiautoscalingv2beta1ExternalMetricStatus), Iok8sapiautoscalingv2beta1ObjectMetricStatus objectProperty = default(Iok8sapiautoscalingv2beta1ObjectMetricStatus), Iok8sapiautoscalingv2beta1PodsMetricStatus pods = default(Iok8sapiautoscalingv2beta1PodsMetricStatus), Iok8sapiautoscalingv2beta1ResourceMetricStatus resource = default(Iok8sapiautoscalingv2beta1ResourceMetricStatus))
        {
            External = external;
        ...
        public Iok8sapiautoscalingv2beta1ExternalMetricStatus External { get; set; }
