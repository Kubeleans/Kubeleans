...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceSubresourceScale
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceSubresourceScale()
        {
            CustomInit();
        }
        ...
        public Iok8sapiextensionsApiserverpkgapisapiextensionsv1beta1CustomResourceSubresourceScale(string specReplicasPath, string statusReplicasPath, string labelSelectorPath = default(string))
        {
