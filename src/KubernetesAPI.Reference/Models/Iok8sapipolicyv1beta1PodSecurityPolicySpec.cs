...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapipolicyv1beta1PodSecurityPolicySpec
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapipolicyv1beta1PodSecurityPolicySpec class.
        /// </summary>
        public Iok8sapipolicyv1beta1PodSecurityPolicySpec()
        {
            CustomInit();
        }
        ...
        public Iok8sapipolicyv1beta1PodSecurityPolicySpec(Iok8sapipolicyv1beta1FSGroupStrategyOptions fsGroup, Iok8sapipolicyv1beta1RunAsUserStrategyOptions runAsUser, Iok8sapipolicyv1beta1SELinuxStrategyOptions seLinux, Iok8sapipolicyv1beta1SupplementalGroupsStrategyOptions supplementalGroups, bool? allowPrivilegeEscalation = default(bool?), IList<string> allowedCapabilities = default(IList<string>), IList<Iok8sapipolicyv1beta1AllowedFlexVolume> allowedFlexVolumes = default(IList<Iok8sapipolicyv1beta1AllowedFlexVolume>), IList<Iok8sapipolicyv1beta1AllowedHostPath> allowedHostPaths = default(IList<Iok8sapipolicyv1beta1AllowedHostPath>), IList<string> defaultAddCapabilities = default(IList<string>), bool? defaultAllowPrivilegeEscalation = default(bool?), bool? hostIPC = default(bool?), bool? hostNetwork = default(bool?), bool? hostPID = default(bool?), IList<Iok8sapipolicyv1beta1HostPortRange> hostPorts = default(IList<Iok8sapipolicyv1beta1HostPortRange>), bool? privileged = default(bool?), bool? readOnlyRootFilesystem = default(bool?), IList<string> requiredDropCapabilities = default(IList<string>), IList<string> volumes = default(IList<string>))
        {
        ...
        public IList<Iok8sapipolicyv1beta1AllowedFlexVolume> AllowedFlexVolumes { get; set; }
        ...
        public IList<Iok8sapipolicyv1beta1AllowedHostPath> AllowedHostPaths { get; set; }
        ...
        public Iok8sapipolicyv1beta1FSGroupStrategyOptions FsGroup { get; set; }
        ...
        public IList<Iok8sapipolicyv1beta1HostPortRange> HostPorts { get; set; }
        ...
        public Iok8sapipolicyv1beta1RunAsUserStrategyOptions RunAsUser { get; set; }
        ...
        public Iok8sapipolicyv1beta1SELinuxStrategyOptions SeLinux { get; set; }
        ...
        public Iok8sapipolicyv1beta1SupplementalGroupsStrategyOptions SupplementalGroups { get; set; }
