...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// defined.
    /// </summary>
    public partial class Iok8sapipolicyv1beta1HostPortRange
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapipolicyv1beta1HostPortRange class.
        /// </summary>
        public Iok8sapipolicyv1beta1HostPortRange()
        {
            CustomInit();
        }
        ...
        public Iok8sapipolicyv1beta1HostPortRange(int max, int min)
        {
            Max = max;
            Min = min;
            CustomInit();
