...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapicorev1ReplicationControllerCondition
    {
        ...
        /// transition.</param>
        public Iok8sapicorev1ReplicationControllerCondition(string status, string type, System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
