...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapiappsv1DeploymentCondition
        /// class.
        /// </summary>
        ...
        /// transition.</param>
        public Iok8sapiappsv1DeploymentCondition(string status, string type, System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastUpdateTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
