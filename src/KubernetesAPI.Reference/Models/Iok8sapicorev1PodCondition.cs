...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapicorev1PodCondition
    {
        ...
        public Iok8sapicorev1PodCondition(string status, string type, System.DateTimeOffset? lastProbeTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
