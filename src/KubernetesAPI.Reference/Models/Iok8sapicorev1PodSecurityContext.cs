...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapicorev1PodSecurityContext
    {
        ...
        /// container.</param>
        public Iok8sapicorev1PodSecurityContext(long? fsGroup = default(long?), long? runAsGroup = default(long?), bool? runAsNonRoot = default(bool?), long? runAsUser = default(long?), Iok8sapicorev1SELinuxOptions seLinuxOptions = default(Iok8sapicorev1SELinuxOptions), IList<long?> supplementalGroups = default(IList<long?>))
        {
            FsGroup = fsGroup;
