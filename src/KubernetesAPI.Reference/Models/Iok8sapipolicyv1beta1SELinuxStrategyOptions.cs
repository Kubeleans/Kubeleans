...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapipolicyv1beta1SELinuxStrategyOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapipolicyv1beta1SELinuxStrategyOptions class.
        /// </summary>
        public Iok8sapipolicyv1beta1SELinuxStrategyOptions()
        {
            CustomInit();
        }
        ...
        public Iok8sapipolicyv1beta1SELinuxStrategyOptions(string rule, Iok8sapicorev1SELinuxOptions seLinuxOptions = default(Iok8sapicorev1SELinuxOptions))
        {
            Rule = rule;
