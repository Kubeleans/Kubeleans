...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapibatchv1JobCondition
    {
        ...
        /// transition.</param>
        public Iok8sapibatchv1JobCondition(string status, string type, System.DateTimeOffset? lastProbeTime = default(System.DateTimeOffset?), System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
