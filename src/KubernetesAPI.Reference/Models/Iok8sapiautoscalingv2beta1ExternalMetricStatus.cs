...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiautoscalingv2beta1ExternalMetricStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiautoscalingv2beta1ExternalMetricStatus class.
        /// </summary>
        public Iok8sapiautoscalingv2beta1ExternalMetricStatus()
        {
            CustomInit();
        }
        ...
        public Iok8sapiautoscalingv2beta1ExternalMetricStatus(string currentValue, string metricName, string currentAverageValue = default(string), Iok8sapimachinerypkgapismetav1LabelSelector metricSelector = default(Iok8sapimachinerypkgapismetav1LabelSelector))
        {
