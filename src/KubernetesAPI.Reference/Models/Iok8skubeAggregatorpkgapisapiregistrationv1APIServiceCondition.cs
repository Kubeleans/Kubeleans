...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8skubeAggregatorpkgapisapiregistrationv1APIServiceCondition
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public Iok8skubeAggregatorpkgapisapiregistrationv1APIServiceCondition()
        {
            CustomInit();
        }
        ...
        public Iok8skubeAggregatorpkgapisapiregistrationv1APIServiceCondition(string status, string type, System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
