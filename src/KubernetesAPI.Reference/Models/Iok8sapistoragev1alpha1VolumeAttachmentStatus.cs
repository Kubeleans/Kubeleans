...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapistoragev1alpha1VolumeAttachmentStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapistoragev1alpha1VolumeAttachmentStatus class.
        /// </summary>
        public Iok8sapistoragev1alpha1VolumeAttachmentStatus()
        {
            CustomInit();
        }
        ...
        /// external-attacher.</param>
        public Iok8sapistoragev1alpha1VolumeAttachmentStatus(bool attached, Iok8sapistoragev1alpha1VolumeError attachError = default(Iok8sapistoragev1alpha1VolumeError), IDictionary<string, string> attachmentMetadata = default(IDictionary<string, string>), Iok8sapistoragev1alpha1VolumeError detachError = default(Iok8sapistoragev1alpha1VolumeError))
        {
        ...
        public Iok8sapistoragev1alpha1VolumeError AttachError { get; set; }
        ...
        public Iok8sapistoragev1alpha1VolumeError DetachError { get; set; }
