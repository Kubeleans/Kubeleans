...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapicorev1ContainerStateTerminated
    {
        ...
        public Iok8sapicorev1ContainerStateTerminated(int exitCode, string containerID = default(string), System.DateTimeOffset? finishedAt = default(System.DateTimeOffset?), string message = default(string), string reason = default(string), int? signal = default(int?), System.DateTimeOffset? startedAt = default(System.DateTimeOffset?))
        {
