...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8sapiautoscalingv2beta1HorizontalPodAutoscalerCondition
    {
        ...
        /// transition.</param>
        public Iok8sapiautoscalingv2beta1HorizontalPodAutoscalerCondition(string status, string type, System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
