...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapistoragev1beta1VolumeAttachmentStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapistoragev1beta1VolumeAttachmentStatus class.
        /// </summary>
        public Iok8sapistoragev1beta1VolumeAttachmentStatus()
        {
            CustomInit();
        }
        ...
        /// external-attacher.</param>
        public Iok8sapistoragev1beta1VolumeAttachmentStatus(bool attached, Iok8sapistoragev1beta1VolumeError attachError = default(Iok8sapistoragev1beta1VolumeError), IDictionary<string, string> attachmentMetadata = default(IDictionary<string, string>), Iok8sapistoragev1beta1VolumeError detachError = default(Iok8sapistoragev1beta1VolumeError))
        {
        ...
        public Iok8sapistoragev1beta1VolumeError AttachError { get; set; }
        ...
        public Iok8sapistoragev1beta1VolumeError DetachError { get; set; }
