...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8skubeAggregatorpkgapisapiregistrationv1APIServiceSpec
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubeAggregatorpkgapisapiregistrationv1APIServiceSpec class.
        /// </summary>
        public Iok8skubeAggregatorpkgapisapiregistrationv1APIServiceSpec()
        {
            CustomInit();
        }
        ...
        public Iok8skubeAggregatorpkgapisapiregistrationv1APIServiceSpec(byte[] caBundle, int groupPriorityMinimum, Iok8skubeAggregatorpkgapisapiregistrationv1ServiceReference service, int versionPriority, string group = default(string), bool? insecureSkipTLSVerify = default(bool?), string version = default(string))
        {
            CaBundle = caBundle;
            Group = group;
        ...
        public Iok8skubeAggregatorpkgapisapiregistrationv1ServiceReference Service { get; set; }
