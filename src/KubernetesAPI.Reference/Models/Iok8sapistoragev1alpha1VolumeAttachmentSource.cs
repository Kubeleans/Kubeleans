...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// can be set.
    /// </summary>
    public partial class Iok8sapistoragev1alpha1VolumeAttachmentSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapistoragev1alpha1VolumeAttachmentSource class.
        /// </summary>
        public Iok8sapistoragev1alpha1VolumeAttachmentSource()
        {
            CustomInit();
        }
        ...
        /// attach.</param>
        public Iok8sapistoragev1alpha1VolumeAttachmentSource(string persistentVolumeName = default(string))
        {
