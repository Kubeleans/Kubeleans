...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapistoragev1alpha1VolumeError
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapistoragev1alpha1VolumeError class.
        /// </summary>
        public Iok8sapistoragev1alpha1VolumeError()
        {
            CustomInit();
        }
        ...
        public Iok8sapistoragev1alpha1VolumeError(string message = default(string), System.DateTimeOffset? time = default(System.DateTimeOffset?))
        {
            Message = message;
            Time = time;
            CustomInit();
