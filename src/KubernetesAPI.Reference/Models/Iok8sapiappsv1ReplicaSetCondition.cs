...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Iok8sapiappsv1ReplicaSetCondition
        /// class.
        /// </summary>
        ...
        /// transition.</param>
        public Iok8sapiappsv1ReplicaSetCondition(string status, string type, System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
