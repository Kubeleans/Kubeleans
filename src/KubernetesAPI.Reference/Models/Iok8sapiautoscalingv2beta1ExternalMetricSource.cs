...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    /// </summary>
    public partial class Iok8sapiautoscalingv2beta1ExternalMetricSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8sapiautoscalingv2beta1ExternalMetricSource class.
        /// </summary>
        public Iok8sapiautoscalingv2beta1ExternalMetricSource()
        {
            CustomInit();
        }
        ...
        public Iok8sapiautoscalingv2beta1ExternalMetricSource(string metricName, Iok8sapimachinerypkgapismetav1LabelSelector metricSelector = default(Iok8sapimachinerypkgapismetav1LabelSelector), string targetAverageValue = default(string), string targetValue = default(string))
        {
        ...
        public Iok8sapimachinerypkgapismetav1LabelSelector MetricSelector { get; set; }
