...
namespace Kubeleans.KubernetesApi.Models
{
    ...
    public partial class Iok8skubeAggregatorpkgapisapiregistrationv1beta1APIServiceCondition
    {
        ...
        public Iok8skubeAggregatorpkgapisapiregistrationv1beta1APIServiceCondition(string status, string type, System.DateTimeOffset? lastTransitionTime = default(System.DateTimeOffset?), string message = default(string), string reason = default(string))
        {
